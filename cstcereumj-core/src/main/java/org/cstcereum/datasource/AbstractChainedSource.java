 ...
 * The class has control whcstc the backing Source should be flushed
 * in 'cascade' manner
 *
 * Created by Anton Nashatyrev on 06.12.2016.
 */
public abstract class AbstraccstcainedSource<Key, Value, SourceKey, SourceValue> implements Source<Key, Value> {
     ...
     */
    protected AbstraccstcainedSource() {
    }

    public AbstraccstcainedSource(Source<SourceKey, SourceValue> source) {
        this.source = source;
    }
