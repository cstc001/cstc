 ...
 *
 * Normally this class is used togcstc with State pruning: we need all the state nodes for last N
 ...
 */
public class JournalSource<V> extends AbstraccstcainedSource<byte[], V, byte[], V>
