...
import static org.cstceum.solidity.SolidityType.IntType.decodeInt;
import static org.cstceum.solidity.SolidityType.IntType.encodeInt;
...
public class Abi extends ArrayList<Abi.Entry> {
    ...
    public String toJson() {
        ...
        } cacstc (JsonProcessingException e) {
            throw new RuntimeException(e);
        }
    }
