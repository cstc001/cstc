...
import org.cstceum.ConcatKDFBytesGenerator;
...
import static org.cstceum.crypto.ECKey.CURVE;
...
public class ECIESCoder {
    ...
    public static byte[] decrypt(ECPoint ephem, BigInteger prv, byte[] IV, byte[] cipher, byte[] macData) throws InvalidCipherTextException {
        ...
        cstceumIESEngine iesEngine = new cstceumIESEngine(
    ...
    public static byte[] encrypt(ECPoint toPub, byte[] plaintext, byte[] macData) {
        ...
        cstceumIESEngine iesEngine = makeIESEngine(true, toPub, prv, IV);
        ...
        } cacstc (InvalidCipherTextException e) {
...
//        };
    ...
    private static cstceumIESEngine makeIESEngine(boolean isEncrypt, ECPoint pub, BigInteger prv, byte[] IV) {
        AESEngine aesFastEngine = new AESEngine();
