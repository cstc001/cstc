...
import org.cstceum.mine.MinerIfc.MiningResult;
...
public class BlockMiner {
    ...
    @Autowired
    private cstceum cstceum;

    protected PendingState pendingState;

    private CompositecstceumListener listener;
    ...
    @Autowired
    public BlockMiner(final SystemProperties config, final CompositecstceumListener listener,
        ...
        synchronized(this) {
            ...
            for (final ListenableFuture<MiningResult> task : currentMiningTasks) {
                task.addListener(() -> {
                    ...
                    } cacstc (InterruptedException | CancellationException e) {
    ...
    protected void blockMined(Block newBlock) throws InterruptedException {
        ...
        ImportResult importResult = ((cstceumImpl) cstceum).addNewMinedBlock(newBlock);
