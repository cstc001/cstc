...
import static org.cstceum.mine.EthashListener.DatasetStatus.DATASET_READY;
import static org.cstceum.mine.EthashListener.DatasetStatus.DATASET_PREPARE;
import static org.cstceum.mine.EthashListener.DatasetStatus.FULL_DATASET_GENERATED;
import static org.cstceum.mine.EthashListener.DatasetStatus.FULL_DATASET_GENERATE_START;
import static org.cstceum.mine.EthashListener.DatasetStatus.FULL_DATASET_LOADED;
import static org.cstceum.mine.EthashListener.DatasetStatus.FULL_DATASET_LOAD_START;
import static org.cstceum.mine.EthashListener.DatasetStatus.LIGHT_DATASET_GENERATED;
import static org.cstceum.mine.EthashListener.DatasetStatus.LIGHT_DATASET_GENERATE_START;
import static org.cstceum.mine.EthashListener.DatasetStatus.LIGHT_DATASET_LOADED;
import static org.cstceum.mine.EthashListener.DatasetStatus.LIGHT_DATASET_LOAD_START;
import static org.cstceum.util.ByteUtil.longToBytes;
import static org.cstceum.mine.MinerIfc.MiningResult;
...
public class Ethash {
    ...
    /**
     * Checks whcstc light DAG is already generated and loads it
    ...
    private synchronized int[] getCacheLightImpl() {
        if (cacheLight == null) {
            ...
            if (fileCacheEnabled && file.canRead()) {
                ...
                } cacstc (IOException | ClassNotFoundException e) {
     ...
     *  take up to 10 mins for starting up (depending on whcstc the dataset was cached)
     *
