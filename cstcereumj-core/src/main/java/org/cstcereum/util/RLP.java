...
import static org.cstceum.util.ByteUtil.*;
 ...
 * RLP is the main encoding method used to serialize objects in cstceum. The
 ...
 * cstceum the standard is that integers are represented in big endian binary
 ...
 * <p>
 * See: https://github.com/cstceum/wiki/wiki/%5BEnglish%5D-RLP
 *
...
public class RLP {
    ...
    public static int decodeInt(byte[] data, int index) {
        ...
        int value = 0;
        // NOTE: From RLP doc:
        // cstceum integers must be represented in big endian binary form
