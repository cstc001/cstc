...
import org.cstceum.vm.program.listener.ProgramListener;
...
public class Storage implements Repository, ProgramListenerAware {
    ...
    @Override
    public void updateBacstc(HashMap<ByteArrayWrapper, AccountState> accountStates, HashMap<ByteArrayWrapper, ContractDetails> contractDetails) {
        ...
        repository.updateBacstc(accountStates, contractDetails);
    }
