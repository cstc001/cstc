 ...
 */
package org.cstceum.vm.program;
...
import org.cstceum.util.ByteArraySet;
import org.cstceum.util.ByteUtil;
import org.cstceum.util.FastByteComparisons;
import org.cstceum.util.Utils;
import org.cstceum.vm.*;
import org.cstceum.vm.PrecompiledContracts.PrecompiledContract;
...
import org.cstceum.vm.program.listener.CompositeProgramListener;
import org.cstceum.vm.program.listener.ProgramListenerAware;
import org.cstceum.vm.program.listener.ProgramStorageChangeListener;
import org.cstceum.vm.trace.ProgramTraceListener;
...
import static org.cstceum.util.BIUtil.*;
...
public class Program {
     ...
     * cstceumj may need to be started with a JVM argument to increase
    ...
    public void createContract(DataWord value, DataWord memStart, DataWord memSize) {
        ...
        // [1] FEcstc THE CODE FROM THE MEMORY
    ...
    public void callToPrecompiledAddress(MessageCall msg, PrecompiledContract contract) {
        ...
        if (requiredGas > msg.getGas().longValue()) {
            ...
            this.refundGas(0, "call pre-compiled"); //macstces cpp logic
            this.stackPushZero();
            track.rollback();
        } else {
    ...
    /**
     * Denotes problem when executing cstceum bytecode.
