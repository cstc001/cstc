...
import static org.cstceum.vm.VMUtils.zipAndEncode;
...
public class TransactionExecutor {
    ...
    private final cstceumListener listener;
    ...
    public TransactionExecutor(Transaction tx, byte[] coinbase, Repository track, BlockStore blockStore,
        ...
        this(tx, coinbase, track, blockStore, programInvokeFactory, currentBlock, new cstceumListenerAdapter(), 0);
    }

    public TransactionExecutor(Transaction tx, byte[] coinbase, Repository track, BlockStore blockStore,
                               ProgramInvokeFactory programInvokeFactory, Block currentBlock,
                               cstceumListener listener, long gasUsedInTheBlock) {
...
//            }
    ...
    public void go() {
        ...
        try {
            ...
            // TODO: cacstc whatever they will throw on you !!!
//            https://github.com/cstceum/cpp-cstceum/blob/develop/libcstceum/Executive.cpp#L241
            rollback();
            m_endGas = BigInteger.ZERO;
