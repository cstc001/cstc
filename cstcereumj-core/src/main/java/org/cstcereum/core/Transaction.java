...
import static org.cstceum.util.ByteUtil.ZERO_BYTE_ARRAY;
...
import org.cstceum.crypto.ECKey.ECDSASignature;
import org.cstceum.crypto.ECKey.MissingPrivateKeyException;
import org.cstceum.crypto.HashUtil;
import org.cstceum.datasource.MemSizeEstimator;
import org.cstceum.util.ByteUtil;
import org.cstceum.util.RLP;
import org.cstceum.util.RLPElement;
import org.cstceum.util.RLPItem;
 ...
 * signed instruction sent by an actor external to cstceum.
...
public class Transaction {
    ...
    /* the amount of cstc to transfer (calculated as wei) */
    private byte[] value;
    ...
    /* the amount of cstc to pay as a transaction fee
    ...
    private Integer extraccstcainIdFromRawSignature(BigInteger bv, byte[] r, byte[] s) {
    ...
    public synchronized void rlpParse() {
        ...
        try {
            ...
            if (transaction.get(6).getRLPData() != null) {
                ...
                this.chainId = extraccstcainIdFromRawSignature(v, r, s);
                if (r != null && s != null) {
