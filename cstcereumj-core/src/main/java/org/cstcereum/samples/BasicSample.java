...
/**
 *  The base sample class which creates cstceumJ instance, tracks and report all the stages
 ...
 *  all components created within cstceumJ. However almost all this could be done without dealing
...
//                throw new RuntimeException("Sync peers failed.");
    ...
    protected void waitForFirstBlock() throws Exception {
        Block currentBest = cstceum.getBlockchain().getBestBlock();
