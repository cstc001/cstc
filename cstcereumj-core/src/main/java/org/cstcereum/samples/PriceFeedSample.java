 ...
 *
 * As a side effect this sample shows how Java wrappers for cstceum contracts can be
...
public class PriceFeedSample extends BasicSample {
    ...
    /**
     * Base class for a cstceum Contract wrapper
     ...
     */
    abstract class cstceumContract {
         ...
         */
        protected cstceumContract(String contractAddr) {
         ...
         *  by their names only
         */
        public cstceumContract(String contractAddr, String contractABI) {
            this.contractAddr = contractAddr;
        ...
        protected Object[] callFunction(String name, String[] inParamTypes, String[] outParamTypes, Object ... args) {
            ...
            ProgramResult result = cstceum.callConstantFunction(contractAddr, function, args);
        ...
        public boolean isExist() {
            return !contractAddr.equals(zeroAddr) && cstceum.getRepository().isExist(Hex.decode(contractAddr));
        }
    }
     ...
     * https://live.cstc.camp/account/985509582b2c38010bfaa3c8d2be60022d3d00da
     */
    class NameRegContract extends cstceumContract {
     ...
     *
     * Contract sources, live state and many more here:
     * https://live.cstc.camp/account/1194e966965418c7d73a42cceeb254d875860356
     */
    class PriceFeedContract extends cstceumContract {
...
//            worker();
    ...
    private void worker() throws Exception{
        ...
        String priceFeedAddress = Hex.toHexString(nameRegContract.addressOf("cstc-camp/price-feed"));
