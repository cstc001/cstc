...
import org.cstceum.mine.EthashListener;
 ...
 * cstceumJ peers in a single JVM. For this two Spring ApplicationContext's are created which
...
public class PrivateMinerSample {
            ...
            for (int i = cstceum.getRepository().getNonce(senderKey.getAddress()).intValue(), j = 0; j < 20000; i++, j++) {
                {
                    Transaction tx = new Transaction(ByteUtil.intToBytesNoLeadZeroes(i),
                            ...
                            receiverAddr, new byte[]{77}, new byte[0], cstceum.gecstcainIdForNextBlock());
                    tx.sign(senderKey);
    ...
    /**
     *  Creating two cstceumJ instances with different config classes
     */
    public static void main(String[] args) throws Exception {
        ...
        cstceumFactory.createcstceum(MinerConfig.class);
