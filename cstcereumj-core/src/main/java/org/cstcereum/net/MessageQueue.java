...
import org.cstceum.net.p2p.PongMessage;
...
import static org.cstceum.net.message.StaticMessages.DISCONNECT_MESSAGE;
...
public class MessageQueue {
    ...
    public void receivedMessage(Message msg) throws InterruptedException {
        ...
        cstceumListener.trace("[Recv: " + msg + "]");
    ...
    private void sendToWire(MessageRoundtrip messageRoundtrip) {
        ...
        if (messageRoundtrip != null && messageRoundtrip.getRetryTimes() == 0) {
            ...
            cstceumListener.onSendMessage(channel, msg);
