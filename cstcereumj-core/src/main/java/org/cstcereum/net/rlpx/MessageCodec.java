...
import org.cstceum.net.p2p.P2pMessageCodes;
import org.cstceum.net.server.Channel;
import org.cstceum.net.shh.ShhMessageCodes;
import org.cstceum.net.swarm.bzz.BzzMessageCodes;
...
import static org.cstceum.net.rlpx.FrameCodec.Frame;
...
public class MessageCodec extends MessageToMessageCodec<Frame, Message> {
    ...
    private boolean supporcstcunkedFrames = false;
    ...
    protected void decode(ChannelHandlerContext ctx, Frame frame, List<Object> out) throws Exception {
        ...
        if (frame.isChunked()) {
            if (!supporcstcunkedFrames && frame.totalFrameSize > 0) {
...
//                    loggerNet.warn("No initial frame received for context-id: " + frame.contextId + ". Discarding this frame as invalid.");
    ...
    private Message decodeMessage(ChannelHandlerContext ctx, List<Frame> frames) throws IOException {
        ...
        cstceumListener.onRecvMessage(channel, msg);
    ...
    public void setSupporcstcunkedFrames(boolean supporcstcunkedFrames) {
        this.supporcstcunkedFrames = supporcstcunkedFrames;
        if (!supporcstcunkedFrames) {
