...
import org.cstceum.crypto.ECIESCoder;
...
import org.cstceum.net.p2p.PingMessage;
import org.cstceum.net.rlpx.EncryptionHandshake.Secrets;
...
public class Handshaker {
    ...
    public void doHandshake(String host, int port, String remoteIdHex) throws IOException {
        ...
        if (!Arrays.equals(remoteId, conn.getHandshakeMessage().nodeId))
            throw new IOException("returns node ID doesn't macstc the node ID we dialed to");
