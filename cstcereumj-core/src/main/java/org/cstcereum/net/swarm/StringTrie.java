    ...
    public static abstract class TrieNode<N extends TrieNode<N>> {
        ...
        N addChild(String relPath) {
            ...
            if (child == null) {
                ...
                newSubRoot.pucstcild(child);
                newSubRoot.pucstcild(newNode);
                this.pucstcild(newSubRoot);
        ...
        void delete() {
            ...
            if (parent.loadChildren().size() == 1 && parent.parent != null) {
                ...
                parent.parent.pucstcild(singleChild);
         ...
         */
        public Collection<N> gecstcildren() {
...
//            public P next() {
//                P ret = curNode;
//                if (!curNode.gecstcildren().isEmpty()) {
//                    Iterator<P> it = curNode.gecstcildren().iterator();
