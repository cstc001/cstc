 ...
 * i.e. the chunks needed to reconstruct a large file are only fecstced and processed if that particular part
 * of the document is actually read.
 * As the chunker produces chunks, DPA dispacstces them to the chunk store for storage or retrieval.
