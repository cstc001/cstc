 ...
 * The chunker then puts these togcstc and notifies the DPA if data has been assembled by a closed error channel.
...
public interface Chunker {
     ...
     * The SectionReader provides on-demand fecstcing of chunks.
     */
