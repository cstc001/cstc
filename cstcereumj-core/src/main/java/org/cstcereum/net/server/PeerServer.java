...
import io.netty.channel.socket.nio.NioServerSockecstcannel;
...
public class PeerServer {
    ...
    private cstceumListener cstceumListener;

    public cstceumChannelInitializer cstceumChannelInitializer;
    ...
    public PeerServer(final SystemProperties config, final ApplicationContext ctx,
                      final cstceumListener cstceumListener) {
        this.ctx = ctx;
        this.config = config;
    ...
    public void start(int port) {
        ...
        cstceumChannelInitializer = ctx.getBean(cstceumChannelInitializer.class, "");

        cstceumListener.trace("Listening on port " + port);
        ...
        try {
            ...
            b.channel(NioServerSockecstcannel.class);
            ...
            b.childHandler(cstceumChannelInitializer);
