...
import org.cstceum.core.BlockHeaderWrapper;
import org.cstceum.core.Transaction;
import org.cstceum.db.ByteArrayWrapper;
import org.cstceum.net.MessageQueue;
import org.cstceum.net.client.Capability;
import org.cstceum.net.eth.handler.Eth;
import org.cstceum.net.eth.handler.EthAdapter;
import org.cstceum.net.eth.handler.EthHandler;
import org.cstceum.net.eth.handler.EthHandlerFactory;
import org.cstceum.net.eth.EthVersion;
import org.cstceum.net.eth.message.Eth62MessageFactory;
import org.cstceum.net.eth.message.Eth63MessageFactory;
import org.cstceum.net.message.ReasonCode;
import org.cstceum.net.rlpx.*;
...
import org.cstceum.net.p2p.P2pMessageFactory;
import org.cstceum.net.rlpx.discover.NodeManager;
import org.cstceum.net.rlpx.discover.NodeStatistics;
import org.cstceum.net.shh.ShhHandler;
import org.cstceum.net.shh.ShhMessageFactory;
import org.cstceum.net.swarm.bzz.BzzHandler;
import org.cstceum.net.swarm.bzz.BzzMessageFactory;
import org.cstceum.util.CollectionUtils;
...
//            handshakeHandler.generateTempKey();
        ...
        messageCodec.secstcannel(this);

        msgQueue.secstcannel(this);
    ...
    public void publicRLPxHandshakeFinished(ChannelHandlerContext ctx, FrameCodec frameCodec,
        ...
        messageCodec.setSupporcstcunkedFrames(false);
    ...
    /**
     * Indicates whcstc this connection was initiated by our peer
     */
    ...
    public void fecstcBlockBodies(List<BlockHeaderWrapper> headers) {
        eth.fecstcBodies(headers);
    }
