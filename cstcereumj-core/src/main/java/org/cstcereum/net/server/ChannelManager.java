...
import org.cstceum.config.NodeFilter;
import org.cstceum.config.SystemProperties;
import org.cstceum.core.Block;
import org.cstceum.core.BlockWrapper;
...
import static org.cstceum.net.message.ReasonCode.DUPLICATE_PEER;
import static org.cstceum.net.message.ReasonCode.TOO_MANY_PEERS;
...
public class ChannelManager {
    ...
    /**
     * Whcstc peer with the same ip is in newPeers, waiting for processing
    ...
    /**
     * Checks whcstc newPeers is not full
