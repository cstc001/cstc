...
import org.cstceum.net.eth.message.GetNodeDataMessage;
import org.cstceum.net.eth.message.GetReceiptsMessage;
import org.cstceum.net.eth.message.NodeDataMessage;
import org.cstceum.net.eth.message.ReceiptsMessage;
...
import static org.cstceum.net.eth.EthVersion.V63;
...
public class Eth63 extends Eth62 {
    ...
    protected synchronized void processNodeData(NodeDataMessage msg) {
        ...
        if(msg.getDataList().isEmpty()) {
            ...
            channel.gecstcannelManager().disconnect(channel, ReasonCode.TOO_MANY_PEERS);
            return;
        }
