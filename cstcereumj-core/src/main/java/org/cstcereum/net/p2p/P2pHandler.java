...
import org.cstceum.net.client.ConfigCapabilities;
...
import org.cstceum.net.swarm.Util;
...
import static org.cstceum.net.eth.EthVersion.*;
import static org.cstceum.net.message.StaticMessages.*;
...
public class P2pHandler extends SimpleChannelInboundHandler<P2pMessage> {
    ...
    public void handlerAdded(ChannelHandlerContext ctx) throws Exception {
        ...
        cstceumListener.trace("P2P protocol activated");
        startTimers();
    }
    ...
    public void channelRead0(final ChannelHandlerContext ctx, P2pMessage msg) throws InterruptedException {
        ...
        cstceumListener.trace(String.format("P2PHandler invoke: [%s]", msg.getCommand()));
...
//                sendGetPeers();
    ...
    public void setHandshake(HelloMessage msg, ChannelHandlerContext ctx) {
        ...
        cstceumListener.onHandShakePeer(channel, msg);
    }
    ...
    public void secstcannel(Channel channel) {
