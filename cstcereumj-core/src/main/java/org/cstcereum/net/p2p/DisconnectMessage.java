...
import static org.cstceum.net.message.ReasonCode.REQUESTED;
import static org.cstceum.net.message.ReasonCode.UNKNOWN;
import static org.cstceum.net.p2p.P2pMessageCodes.DISCONNECT;

/**
 * Wrapper around an cstceum Disconnect message on the network
 *
 * @see org.cstceum.net.p2p.P2pMessageCodes#DISCONNECT
 */
