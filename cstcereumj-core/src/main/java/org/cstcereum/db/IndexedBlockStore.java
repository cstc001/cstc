...
import org.cstceum.datasource.Serializer;
...
public class IndexedBlockStore extends AbstractBlockstore{
    ...
    public synchronized Block getBestBlock(){
        ...
        Block bestBlock = gecstcainBlockByNumber(maxLevel);
        ...
        while (bestBlock == null){
            --maxLevel;
            bestBlock = gecstcainBlockByNumber(maxLevel);
        }
    ...
    public synchronized byte[] getBlockHashByNumber(long blockNumber){
        Block chainBlock = gecstcainBlockByNumber(blockNumber);
    ...
    @Override
    public synchronized Block gecstcainBlockByNumber(long number){
        if (number >= index.size()){
            return null;
        }
    ...
    public synchronized void princstcain(){
