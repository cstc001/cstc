...
import org.cstceum.net.rlpx.FindNodeMessage;
import org.cstceum.net.rlpx.Message;
import org.cstceum.net.rlpx.discover.DiscoveryEvent;
import org.cstceum.net.rlpx.discover.PacketDecoder;
    ...
    public Channel create(String bindAddr, int port) throws InterruptedException {
        ...
        b.group(group)
            ...
            .handler(new ChannelInitializer<NioDatagramChannel>() {
                @Override
                public void inicstcannel(NioDatagramChannel ch)
                        throws Exception {
