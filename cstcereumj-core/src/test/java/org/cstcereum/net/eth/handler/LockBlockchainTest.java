...
import org.cstceum.net.eth.message.GetBlockBodiesMessage;
import org.cstceum.net.eth.message.GetBlockHeadersMessage;
...
/**
 * Testing whcstc Eth handler {@link Eth62} is blocking {@link BlockchainImpl}
 */
public class LockBlockchainTest {
    ...
    public LockBlockchainTest() {
        ...
        final BlockStore blockStoreDummy = new BlockStoreDummy() {
            @Override
            public synchronized Block gecstcainBlockByNumber(long blockNumber) {
                return super.gecstcainBlockByNumber(blockNumber);
            }
