...
public class IterableTestRepository implements Repository {
    ...
    @Override
    public void updateBacstc(HashMap<ByteArrayWrapper, AccountState> accountStates, HashMap<ByteArrayWrapper, ContractDetails> contractDetailes) {
        src.updateBacstc(accountStates, contractDetailes);
