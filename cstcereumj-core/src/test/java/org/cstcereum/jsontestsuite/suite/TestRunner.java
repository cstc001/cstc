...
import org.cstceum.jsontestsuite.suite.builder.BlockBuilder;
import org.cstceum.jsontestsuite.suite.builder.RepositoryBuilder;
import org.cstceum.jsontestsuite.suite.model.BlockTck;
import org.cstceum.jsontestsuite.suite.validators.BlockHeaderValidator;
import org.cstceum.jsontestsuite.suite.validators.RepositoryValidator;
import org.cstceum.listener.cstceumListenerAdapter;
import org.cstceum.util.ByteUtil;
import org.cstceum.validator.DependentBlockHeaderRuleAdapter;
import org.cstceum.vm.DataWord;
import org.cstceum.vm.LogInfo;
import org.cstceum.vm.VM;
import org.cstceum.vm.program.Program;
import org.cstceum.vm.program.invoke.ProgramInvoke;
import org.cstceum.vm.program.invoke.ProgramInvokeFactoryImpl;
import org.cstceum.vm.program.invoke.ProgramInvokeImpl;
import org.cstceum.vm.trace.ProgramTrace;
...
import static org.cstceum.crypto.HashUtil.shortHash;
import static org.cstceum.util.ByteUtil.EMPTY_BYTE_ARRAY;
import static org.cstceum.vm.VMUtils.saveProgramTraceFile;
...
public class TestRunner {
    ...
    public List<String> runTestCase(BlockTestCase testCase) {
        ...
        PendingStateImpl pendingState = new PendingStateImpl(new cstceumListenerAdapter());
        ...
        //Check state root macstces last valid block
        ...
        if (!finalRoot.equals(currRoot)){
            String formattedString = String.format("Root hash doesn't macstc best: expected: %s current: %s",
                    finalRoot, currRoot);
    ...
    public List<String> runTestCase(TestCase testCase) {
        ...
        try {
            ...
            if (testCase.getPost() == null) {
                ...
                List<org.cstceum.vm.CallCreate> resultCallCreates =
                        program.getResult().getCallCreateList();

                // assert call creates
                for (int i = 0; i < testCase.getCallCreateList().size(); ++i) {

                    org.cstceum.vm.CallCreate resultCallCreate = null;
...
//          repository.close();
    ...
    public org.cstceum.core.Transaction createTransaction(Transaction tx) {
        ...
        org.cstceum.core.Transaction transaction = new org.cstceum.core.Transaction(
