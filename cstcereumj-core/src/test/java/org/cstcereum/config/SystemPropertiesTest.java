...
public class SystemPropertiesTest {
    ...
    public void testRequireEitherNameOrClassConfiguration() {
        try {
            SystemProperties props = new SystemProperties();
            props.overrideParams("blockchain.config.name", "test", "blockchain.config.class", "org.cstceum.config.net.TestNetConfig");
            props.getBlockchainConfig();
    ...
    public void testRequireTypeBlockchainNetConfigOnManualClass() {
        SystemProperties props = new SystemProperties();
        props.overrideParams("blockchain.config.name", null, "blockchain.config.class", "org.cstceum.config.net.TestNetConfig");
    ...
    public void testNonExistentBlockchainNetConfigClass() {
        SystemProperties props = new SystemProperties();
        try {
            props.overrideParams("blockchain.config.name", null, "blockchain.config.class", "org.cstceum.config.net.NotExistsConfig");
            props.getBlockchainConfig();
            fail("Should throw exception for invalid class");
        } cacstc (RuntimeException expected) {
            assertEquals("The class specified via blockchain.config.class 'org.cstceum.config.net.NotExistsConfig' not found", expected.getMessage());
        }
    }
    ...
    public void testNotInstanceOfBlockchainForkConfig() {
        ...
        try {
            props.overrideParams("blockchain.config.name", null, "blockchain.config.class", "org.cstceum.config.NodeFilter");
            props.getBlockchainConfig();
            fail("Should throw exception for invalid class");
        } cacstc (RuntimeException expected) {
            assertEquals("The class specified via blockchain.config.class 'org.cstceum.config.NodeFilter' is not instance of org.cstceum.config.BlockchainForkConfig", expected.getMessage());
        }
    }
    ...
    private void assertInvalidNodeId(String nodeId) {
        ...
        } cacstc (RuntimeException ignore) { }
    }
