...
public class NodeFilterTest {
    ...
    @Test
    public void doNotAcceptTheCacstcAllWildcard() throws Exception {
        NodeFilter filter = new NodeFilter();
        filter.add(NODE_1, "*");
    ...
    @Test
    public void acceptNullIpPatternAsCacstcAllForNodes() throws Exception {
        NodeFilter filter = new NodeFilter();
    ...
    @Test
    public void acceptNullIpPatternAsCacstcAllForInetAddresses() throws Exception {
        NodeFilter filter = new NodeFilter();
        filter.add(NODE_1, null);
