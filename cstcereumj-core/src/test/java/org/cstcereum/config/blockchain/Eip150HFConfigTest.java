 ...
 * </ul>
 * <p>Source -- https://github.com/cstceum/EIPs/blob/master/EIPS/eip-150.md</p>
 */
public class Eip150HFConfigTest {
    ...
    public void testParentInheritedProperties() {
        ...
        Transaction txWithoucstcainId = new Transaction(emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, null);
        assertTrue(eip150.acceptTransactionSignature(txWithoucstcainId));
