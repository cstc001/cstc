...
public class ByzantiumConfigTest {
    ...
    public void testPredefinedChainId() throws Exception {
        ...
        assertEquals(1, (int) byzantiumConfig.gecstcainId());
    }
    ...
    @Test
    @Ignore
    public void testcstcscanIoBlock4490790() throws Exception {
        ByzantiumConfig byzantiumConfig = new ByzantiumConfig(new TestBlockchainConfig());

        // https://cstcscan.io/block/4490788
        ...
        // https://cstcscan.io/block/4490789
        ...
        BigInteger actualDifficultyOncstcscan = BlockHeaderBuilder.parse("1,377,927,933,620,791");
        assertTrue(actualDifficultyOncstcscan.compareTo(minimumDifficulty) > -1);
    }
