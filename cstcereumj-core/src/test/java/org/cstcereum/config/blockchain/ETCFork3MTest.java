...
public class ETCFork3MTest {
    /**
     * cstceum Classic's Chain ID should be '61' according to
     * https://github.com/cstceum/EIPs/blob/master/EIPS/eip-155.md
     */
    @Test
    public void textPredefinedChainId() throws Exception {
        ETCFork3M etcFork3M = new ETCFork3M(new TestBlockchainConfig());
        assertEquals(61, (int) etcFork3M.gecstcainId());
    }
    ...
    /**
     * https://github.com/cstceumproject/ECIPs/blob/master/ECIPs/ECIP-1010.md
     *
     <pre>
