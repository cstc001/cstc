...
import static org.cstceum.TestUtils.*;
...
public class IndexedBlockStoreTest {
    ...
    public void test1(){
        ...
        //  testing:  gecstcainBlockByNumber(long)

        block  = blocks.get(50);
        block_ = indexedBlockStore.gecstcainBlockByNumber(block.getNumber());
        assertEquals(block.getNumber(), block_.getNumber());
        ...
        block_  = indexedBlockStore.gecstcainBlockByNumber(10000);
        assertEquals(null, block_);
    ...
    public void test8() throws IOException {
        ...
        try {
            ...
            for (Block currBlock : forkLine){
                ...
                Block chainBlock = indexedBlockStore.gecstcainBlockByNumber(number);
    ...
    public void myTest() throws Exception {
        ...
        Block sb2 = bc.getBlockchain().getBlockStore().gecstcainBlockByNumber(2);
        Block sb3 = bc.getBlockchain().getBlockStore().gecstcainBlockByNumber(3);
        ...
        sb2 = ibs1.gecstcainBlockByNumber(2);
        sb3 = ibs1.gecstcainBlockByNumber(3);
        Block sb4 = ibs1.gecstcainBlockByNumber(4);
        Assert.assertTrue(sb2.isEqual(b2_));
        Assert.assertTrue(sb3.isEqual(b3_));
