...
import org.cstceum.crypto.ECKey.MissingPrivateKeyException;
import org.cstceum.crypto.HashUtil;
import org.cstceum.db.BlockStoreDummy;
import org.cstceum.jsontestsuite.suite.StateTestSuite;
import org.cstceum.jsontestsuite.suite.runners.StateTestRunner;
...
import static org.cstceum.solidity.SolidityType.*;
...
public class TransactionTest {
    ...
    // Testdata from: https://github.com/cstceum/tests/blob/master/txtest.json
...
//        Transaction tx = new Transaction(Hex.decode(rlp));
        ...
        */
        ...
        List<String> res = new StateTestRunner(stateTestSuite.getTestCases().get("test1")) {
            ...
            protected ProgramResult executeTransaction(Transaction tx) {
                // first emulating the constant call (cstceum.callConstantFunction)
    ...
    public void homesteadContractCreationTest() throws Exception {
        ...
        // https://github.com/cstceum/EIPs/blob/master/EIPS/eip-2.mediawiki
    ...
    public void afterEIP158Test() throws Exception {
        ...
        assertEquals((int)txSigned.gecstcainId(), chainId);
    }
    ...
    public void etcChainIdTest() {
        ...
        Integer chainId = tx.gecstcainId();
    ...
    public void longChainIdTest() {
        ...
        assertEquals(333333, tx2.gecstcainId().intValue());
    ...
    public void unsignedChainIdTransactionTest() {
        ...
        assertEquals(333333, (long) tx.gecstcainId());
        Transaction copyTx = new Transaction(tx.getNonce(), tx.getGasPrice(), tx.getGasLimit(), tx.getReceiveAddress(), tx.getValue(), tx.getData(), tx.gecstcainId());
