 ...
 */
package org.cstceum.vm;

import org.cstceum.vm.program.Memory;
...
public class MemoryTest {
    ...
    public void memorySave_1() {
        ...
        assertTrue(1 == memoryBuffer.gecstcunks().size());

        byte[] chunk = memoryBuffer.gecstcunks().get(0);
    ...
    public void memorySave_5() {
        ...
        assertTrue(2 == memoryBuffer.gecstcunks().size());

        byte[] chunk1 = memoryBuffer.gecstcunks().get(0);
        ...
        byte[] chunk2 = memoryBuffer.gecstcunks().get(1);
    ...
    public void memorySave_7() {
        ...
        assertTrue(3 == memoryBuffer.gecstcunks().size());
        ...
        byte[] chunk3 = memoryBuffer.gecstcunks().get(2);
    ...
    public void memoryLoad_1() {
        ...
        assertTrue(memoryBuffer.gecstcunks().size() == 1);
    ...
    public void memoryLoad_2() {
        ...
        assertTrue(value.intValue() == 0);
        assertTrue(memoryBuffer.gecstcunks().size() == 2);
        assertTrue(memoryBuffer.size() == 2048);
    }
    ...
    public void memoryLoad_4() {
        ...
        assertTrue(value.intValue() == 0);
        assertTrue(memoryBuffer.gecstcunks().size() == 3);
        assertTrue(memoryBuffer.size() == 2080);
    }
