...
public class ShortSyncTest {
    ...
    public void test3() throws InterruptedException {
        ...
        Blockchain blockchainA = (Blockchain) cstceumA.getBlockchain();
        Blockchain blockchainB = (Blockchain) cstceumB.getBlockchain();
    ...
    public void test5() throws InterruptedException {
        ...
        final CountDownLacstc semaphore = new CountDownLacstc(1);
        final CountDownLacstc semaphoreB8_ = new CountDownLacstc(1);
        cstceumB.addListener(new cstceumListenerAdapter() {
            @Override
            public void onBlock(Block block, List<TransactionReceipt> receipts) {
                if (block.isEqual(b10)) {
    ...
    public void test6() throws InterruptedException {
        ...
        final CountDownLacstc semaphore = new CountDownLacstc(1);
        final CountDownLacstc semaphoreB7 = new CountDownLacstc(1);
        cstceumB.addListener(new cstceumListenerAdapter() {
            @Override
            public void onBlock(Block block, List<TransactionReceipt> receipts) {
                if (block.isEqual(b7)) {
    ...
    public void test7() throws InterruptedException {
        ...
        final Blockchain blockchainA = (Blockchain) cstceumA.getBlockchain();
        Blockchain blockchainB = (Blockchain) cstceumB.getBlockchain();
    ...
    public void test8() throws InterruptedException {
        ...
        final CountDownLacstc semaphore = new CountDownLacstc(1);
        final CountDownLacstc semaphoreB7_ = new CountDownLacstc(1);
        cstceumB.addListener(new cstceumListenerAdapter() {
            @Override
            public void onBlock(Block block, List<TransactionReceipt> receipts) {
    ...
    public void test9() throws InterruptedException {
        ...
        final CountDownLacstc semaphoreDisconnect = new CountDownLacstc(1);
        ...
        final CountDownLacstc semaphoreConnect = new CountDownLacstc(1);
        cstceumB.addListener(new cstceumListenerAdapter() {
            @Override
    ...
    public void test11() throws InterruptedException {
        ...
        Blockchain blockchainA = (Blockchain) cstceumA.getBlockchain();
        final Blockchain blockchainB = (Blockchain) cstceumB.getBlockchain();
        ...
        final CountDownLacstc semaphore1 = new CountDownLacstc(1);
        final CountDownLacstc semaphore2 = new CountDownLacstc(1);
        cstceumB.addListener(new cstceumListenerAdapter() {
            @Override
            public void onBlock(Block block, List<TransactionReceipt> receipts) {
    ...
    // bodies validation: ancestor's parent hash and header's hash does not macstc, reverse = true
    // expected: B drops A
    @Test
