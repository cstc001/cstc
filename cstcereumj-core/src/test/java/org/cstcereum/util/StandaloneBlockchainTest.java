...
public class StandaloneBlockchainTest {
    ...
    public void invalidTxTest() {
        ...
        ECKey bob = new ECKey();
        sb.sendcstc(bob.getAddress(), BigInteger.valueOf(1000));
        sb.setSender(bob);
        sb.sendcstc(alice.getAddress(), BigInteger.ONE);
        sb.setSender(alice);
        sb.sendcstc(bob.getAddress(), BigInteger.valueOf(2000));
    ...
    public void initBalanceTest() {
        ...
        ECKey alice = sb.getSender();
        ECKey bob = new ECKey();
        sb.withAccountBalance(bob.getAddress(), convert(123, cstc));
        ...
        assert convert(123, cstc).equals(bobInitBal);
        ...
        assert convert(123, cstc).compareTo(sb.getBlockchain().getRepository().getBalance(bob.getAddress())) > 0;
