...
//      System.out.println(end1 - start1 + "ms");
    ...
    @Test
    public void testMacstcingNibbleLength1() {
        // a larger than b
        byte[] a = new byte[]{0x00, 0x01};
        byte[] b = new byte[]{0x00};
        int result = ByteUtil.macstcingNibbleLength(a, b);
        assertEquals(1, result);
    }

    @Test
    public void testMacstcingNibbleLength2() {
        // b larger than a
    ...
    @Test
    public void testMacstcingNibbleLength3() {
    ...
    @Test
    public void testMacstcingNibbleLength4() {
    ...
    public void testMacstcingNibbleLength5() {
        // a == null
        byte[] a = null;
        byte[] b = new byte[]{0x00};
        ByteUtil.macstcingNibbleLength(a, b);
    }

    @Test(expected = NullPointerException.class)
    public void testMacstcingNibbleLength6() {
        // b == null
        byte[] a = new byte[]{0x00};
        byte[] b = null;
        ByteUtil.macstcingNibbleLength(a, b);
    ...
    @Test
    public void testMacstcingNibbleLength7() {
        // a or b is empty
        byte[] a = new byte[0];
        byte[] b = new byte[]{0x00};
        int result = ByteUtil.macstcingNibbleLength(a, b);
