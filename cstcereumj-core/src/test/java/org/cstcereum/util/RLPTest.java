...
import static org.cstceum.util.ByteUtil.byteArrayToInt;
import static org.cstceum.util.ByteUtil.wrap;
import static org.cstceum.util.RLP.*;
import static org.junit.Assert.*;
import static org.cstceum.util.RlpTestData.*;
...
public class RLPTest {
    ...
    public void test7() {
        ...
        String test = "cstceumJ Client";
        data = encodeString(test);

        assertArrayEquals(expected, data);

        String test2 = "cstceum(++)/ZeroGox/v0.5.0/ncurses/Linux/g++";
        ...
        String test3 = "cstceum(++)/ZeroGox/v0.5.0/ncurses/Linux/g++cstceum(++)/ZeroGox/v0.5.0/ncurses/Linux/g++";
...
//        2240089100000070
    ...
    /************************************
     * Test data from: https://github.com/cstceum/wiki/wiki/%5BEnglish%5D-RLP
     *
